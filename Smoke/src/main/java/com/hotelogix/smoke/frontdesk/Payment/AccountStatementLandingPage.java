...
import com.hotelogix.smoke.FrontdeskTest.Ftest;
...
public class AccountStatementLandingPage {
	...
	@FindBy(xpath="//td[@class='frn_total_g']//table/tbody//tr[2]//td[2]")
	...
	@FindBy(xpath="(//div[@class='bc-heading']/h2)[3]")
	public WebElement Text_AccountStatement;

	//@FindBy(xpath="//form/div/table/tbody/tr/td/table[3]/tbody/tr[4]/td/table/tbody/tr")
	@FindBy(xpath="//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr")
	...
	@FindBy(xpath="//div[@id='PanelCreateNewFolioGr_h']")
	public WebElement HeaderTxt_CreateNewFolioforGrp;
	...
	@FindBy(xpath="//div[@id='PanelRouteGroupTr_h']")
	public WebElement Header_routeChargesTitleforGrp;
	...
	@FindBy(xpath="//input[@id='btnRoutePayment']")
	public WebElement Btn_RoutePaymentforGrp;

	@FindBy(xpath="//div[@id='PanelRouteGroupPay_h']")
	public WebElement Header_routePaymentTitle;


	@FindBy(xpath="//div[@id='PanelRouteGroupPayGR_h']")
	public WebElement Header_routePaymentTitleforGrp;
	...
	@FindBy(xpath="//div[@id='PanelGroupRefund_h']")
	public WebElement Header_refundTitleForGrp;
	...
	@FindBy(xpath="(//td[@class='frn_total_g'])[4]")
	...
	@FindBy(xpath="//div[@class='border-container mx-2 dont-print-me-hidden']//table[@class='table table-striped table-hover']//tr[3]/td[5]")
	public WebElement Text_BalanceAmtInFolio;

	//@FindBy(xpath="//table[contains(@id,'flListTable_')]/tbody/tr[4]/td[7]/span")
	@FindBy(xpath="	//i[@class='fa-solid fa-lock-open']")
	public WebElement Btn_FolioLock;
	
	
	//@FindBy(xpath="//table[contains(@id,'flListTable_')]/tbody/tr[4]/td[7]/span")
		@FindBy(xpath="//i[@class='fa-solid fa-lock']")
		public WebElement Btn_FolioLocked;

	@FindBy(xpath="//i[@class='fa-solid fa-lock-open']")
	public WebElement Btn_LockFolio;

	@FindBy(xpath="(//a[starts-with(text(),'INV')])[1]")
	public WebElement Link_InvoiceNumber;

	@FindBy(xpath="//td[starts-with(text(),'Seasonal Rate')]")
	public WebElement Txt_RateType;

	@FindBy(xpath="//select[@id='selPOSRoomOwner']")
	public WebElement DD_RoomOwner;

	@FindBy(xpath="//input[@id='btnGrpCustomCharge']")
	public WebElement Btn_GroupCustomCharge;

	@FindBy(xpath="//input[@id='btnGrpOtherCharge']")
	public WebElement Btn_GroupOtherCharges;

	@FindBy(xpath="//input[starts-with(@id,'chkboxMail_')]")
	public WebElement AllPerfomaInv;


	@FindBy(xpath="//table[starts-with(@id,'flListTable_')]//tr//td//a")
	public List<WebElement> AllPIs; 

	@FindBy(xpath="//td[@class='frn_total_g']")
	public List<WebElement> AllTotalRate;
	...
	public float fn_GetBalanceAmt() throws Exception{
		float balAmt=0.0f;
		try{
			Thread.sleep(3000);
			int size=AllTotalRate.size();
			String rateStr=AllTotalRate.get(size-1).getText();
			balAmt=GenericMethods.fn_getRateFromRateString(rateStr);
		}
		catch(Exception e){
			throw e;
		}
	...
	public ArrayList<String> fn_getAllPI() throws Exception{
		ArrayList<String> allPI=new ArrayList<String>();
		try{
			int size=AllPIs.size();
			for(int i=0;i<=size-1;i++){
				String PI=AllPIs.get(i).getText();
				System.out.println((i+1)+" number of PI" + PI );
				allPI.add(PI);
			}
		}
		catch(Exception e){
	...
	public ReservationFolioPage fn_clickOnFolio(String folioNum) throws Exception{
		try{
			Thread.sleep(3000);
			GenericMethods.scrollUp("500");
			int size=AllPIs.size();
			for(int i=0;i<=size-1;i++){
				String PI=AllPIs.get(i).getText();
				if(PI.equals(folioNum)){
					GenericMethods.javascriptScroll(AllPIs.get(i));
					Thread.sleep(2000);
					Thread.sleep(3000);
					GenericMethods.scrollUp("500");
					AllPIs.get(i).click();
	...
	public WebElement fn_checkPosFolio(String folioNumToSearch){
		WebElement ele=null;
		try{
			String s1=GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']//tr[2]//td[4]")).getText();
			if(s1.contains(folioNumToSearch))
			{
				ele=	GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']//tr[2]//td[4]"));	
			}
			}
		catch(Exception e){
	...
	public void fn_doPaymentUsingCheque(int iTestCaseRow) throws Exception{
		try{
			GenericMethods.javascriptScroll(DD_PayMode);
			GenericMethods.selectElement(DD_PayMode, ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_PayMode)));
			Thread.sleep(6000);

			//		String str=ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_PayType));
			//		ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_PayType))
			try{
				GenericMethods.selectElement(DD_PayType, "Cheque");
				Thread.sleep(6000);
			}catch(Exception e){
				GenericMethods.selectElement(DD_PayType, "Cheque");
			}
	...
	public float fn_getChargeForPostedItem() throws Exception{
		...
		try{
			...
			for(int i=2;i<=AllAccountStatement_row.size()-2;i=+2){
				...
				size=size-1;
				String text=GenericMethods.driver.findElement(By.xpath("//td[@class='frn_total'][7]")).getText().trim();

				
				//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']//tbody//tr[5]//td[7]
	...
	public float fn_getTotalAmountfromAccountStatement() throws Exception{
		...
		try{
			...
			for(int i=4;i<=AllAccountStatement_row.size()-2;i+=2){
				System.out.println("Value of i"+i);
				size=size-3;
				String text=GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+size+"]/td[7]")).getText().trim();
				System.out.println("--------------------price"+text);
	...
	public float fn_getTotalAmountfromAccountStatementP17() throws Exception{
		float tamt=0.0f;
		try{
			int size=AllAccountStatement_row.size();
			System.out.println(size+"::::::::is the size");
	...
	public float fn_verifyRoutedPayment(String pi) throws Exception {
		...
		float Rate=0.0f;
		Thread.sleep(5000);
		System.out.println("PI from argument is::::::::::"+pi);
		try{
			for(int i=2;i<=All_folio.size()-1;i++){
				System.out.println("Size is::::"+All_folio.size());
				System.out.println("i value is::::::::::::::::"+i);
				//System.out.println("Text value::::::::::::::::::::::"+GenericMethods.driver.findElement(By.xpath("//table[starts-with(@id,'flListTable_')]//tr["+i+"]/td[2]/a")).getText());
				String PI=GenericMethods.driver.findElement(By.xpath("//table[starts-with(@id,'flListTable_')]//tr["+i+"]/td[2]/a")).getText();
				if(PI.equals(pi)){
					String rate1=GenericMethods.driver.findElement(By.xpath("//table[starts-with(@id,'flListTable_')]//tr["+i+"]/td[4]")).getText();
					Rate=Float.parseFloat(rate1);
					System.out.println("Value of rate 2 is::::"+Rate);
					break;
				}
			}
		}
	...
	public String fn_routePayment(int iTestCaseRow ,int index,String str) throws Exception{
		try{


			//String text1=GenericMethods.driver.findElement(By.xpath("//form/div/table/tbody/tr/td/table[3]/tbody/tr[4]/td/table/tbody/tr[2]/td[4]")).getText().trim();

			for(int i=1;i<=All_PostedItemInAccountStatement.size()-2;i=+2){


				//All_PostedItemInAccountStatement=GenericMethods.driver.findElements(By.xpath("//form/div/table/tbody/tr/td/table[3]/tbody/tr[4]/td/table/tbody/tr"));
				Thread.sleep(2000);

				String text=GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[4]")).getText().trim();

				if(text.startsWith("Paid by")){
					Thread.sleep(3000);
					GenericMethods.javascriptScroll(Text_AccountStatement);
					GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[2]/input[@type='checkbox']")).click();
					Thread.sleep(2000);
					...
					if(str.equalsIgnoreCase("single")){
						...
						GenericMethods.clickElement(Btn_RoutePaymentforGrp);
						Assert.assertEquals(GenericMethods.getText(Header_routePaymentTitleforGrp).trim(), ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_ExpectedResult3)).trim(), "Matched");

					}
					Thread.sleep(2000);
					System.out.println("Set value in route payment::::");
					...
					System.out.println("Set value in route payment::::"+selValue);
	...
	public void doPayment(String mode) throws Exception{
		try{
			GenericMethods.javascriptScroll(Btn_PayNow);
	...
	public float VerifyRoutedCharge(String pi) throws Exception{
		float Rate=0.0f;
		try{
			for(int i=2;i<=All_folio.size()-2;i++){
				String PI=GenericMethods.driver.findElement(By.xpath("//table[starts-with(@id,'flListTable_')]//tr["+i+"]/td[2]/a")).getText();
				if(PI.equals(pi)){
					i=i+1;
					String rate=GenericMethods.driver.findElement(By.xpath("//table[starts-with(@id,'flListTable_')]//tr["+i+"]/td[3]")).getText();
				String	finalrate[]=rate.split("\\s+");
				if(finalrate[1].contains(","))
				{
					String fix[]=finalrate[1].split(",");
					String result=fix[0]+fix[1];
				...
				{
					Rate=Float.parseFloat(finalrate[1]);
					break;
				}
				}
			}
	...
	public float fn_getTotalPostedItemRatefromAccountStatement() throws Exception{
		...
		try{
			int size=0;
			if(Ftest.sTestCaseName.contains("verifyRouteToNewFolioRouteChargeAndRoutePayment"))
			{
			size=AllAccountStatement_row.size()-2;
			}
			else
			{
				size=AllAccountStatement_row.size()-1;
			}
			String rate=GenericMethods.driver.findElement(By.xpath("//td[@class='frn_total'][7]")).getText();
			float rate1=GenericMethods.fn_getRateFromRateString(rate);
			System.out.println(rate1);
			String tax=GenericMethods.driver.findElement(By.xpath("//td[@class='frn_total'][8]")).getText();
			float tax1=GenericMethods.fn_getRateFromRateString(tax);
	...
	/*public void fn_createNewFolioForGrpRes(int index) throws Exception{
try{
Thread.sleep(2000);
gNameforFolio=GenericMethods.selectValueFromDropdownUsingIndex(DD_NewFolioToGuest, index);
Thread.sleep(2000);
GenericMethods.clickElement(Btn_CreateNewFolio);
	...
	public String VerifyOtherCharges(String str) throws Exception {
		...
		try{
			...
			for(int i=1;i<=size-2;i=i+2){
				s=GenericMethods.driver.findElement(By.xpath("//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[4]/a")).getText();
	...
	public void fn_addOtherCharge(int iTestCaseRow) throws Exception{
		try{
			selRoomOwnerForOtherCharge=GenericMethods.selectValueFromDropdownUsingIndex(DD_RoomOwner, 0);	
			System.out.println("Hey");
			Thread.sleep(3000);
			GenericMethods.selectValueFromDropdownUsingIndex(DD_POSPointOtherCharges, 1);	
			Thread.sleep(3000);
			...
			Thread.sleep(2000);
			System.out.println("before save and scroll");
			GenericMethods.javascriptScroll(Btn_SaveOtherCharges);
			Thread.sleep(4000);
	...
	public String VerifyPostedCustomCharge(int iTestCaseRow) throws Exception{
		...
		try{
			...
			for(int i=1;i<=size-1;i=i+2){
				item=GenericMethods.driver.findElement(By.xpath("//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[4]/a")).getText();
				System.out.println("Item text::"+item);
	...
	public void fn_selectAddedCustCharge(int iTestCaseRow) throws Exception{
		String item=null;
		try{
			int size=Text_AccountRecords.size();
			for(int i=1;i<=size-2;i=i+2){
				item=GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[4]/a")).getText();
				if(item.equals(ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_Description)))){
					Thread.sleep(2000);
					GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[2]/input")).click();
					break;
	...
	public String fn_clkRefundGrp() throws Exception{
		try{
			GenericMethods.clickElement(Btn_Refund);
			String str=GenericMethods.getText(Header_refundTitleForGrp);
			GenericMethods.clickElement(Btn_innerRefund);
			return str;
		}catch(Exception e){
			throw e;
		}
	...
	public void fn_AddCustomCharges(int iTestCaseRow) throws Exception{
		try{
			...
			roomOwner=GenericMethods.selectValueFromDropdownUsingIndex(DD_RoomOwner,0 );
			Thread.sleep(2000);
			selPOSpoint= GenericMethods.selectValueFromDropdownUsingIndex(DD_POSDropdownInCustomChargeAllowance,1 );
			Thread.sleep(4000);
	...
	public void  VerifyRoomRateAndTax(String str) throws Exception{
		try{
			int size=Text_AccountRecords.size();
			for(int i=1;i<=size-2;i=i+2){
				String text=GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[4]/a")).getText();
				if(text.startsWith(str)){
					postedRoomPrice=GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[7]")).getText();
					Thread.sleep(2000);
					postedRoomTax=GenericMethods.driver.findElement(By.xpath("//div[@class='border-container ms-3 me-2']//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[8]")).getText();
					break;
	...
	public String getFolioNumberfromAccountNumber(String folioNum) throws Exception{
		...
		try{
			int size=Text_AccountRecords.size();
			System.out.println("Size came as:::"+size);
			for(int i=1;i<=size-2;i=+2){

				Thread.sleep(2000);

				fnum=GenericMethods.driver.findElement(By.xpath("//table[@class='table table-striped table-hover']/tbody/tr["+i+"]/td[4]/span/a")).getText();
				Thread.sleep(2000);
	...
	/*public void ClickToCustomCharge() throws Exception
{
	...
	public void fn_addOtherChargee() throws Exception
	{
		try
		{
